...
```json Response
{
  ...
  "tools": [
    ...
    {
      "name": "verify_wallet",
      "description": "Unimplemented / beta: returns placeholder data, not a real result. Free ($0) until real logic ships. Check wallet trust score for crypto payments. Supports EVM and Solana addresses.",
      "inputSchema": {
        "type": "object",
        "properties": {
...
```json Response
{
  ...
  "description": "Real-time trust scoring for AI agents, businesses, and transactions. Up to 7 data sources. One API call.",
