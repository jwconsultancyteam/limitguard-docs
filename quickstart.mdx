...
Test the API without calling real data sources or paying for calls by adding the sandbox header:
...
Remove the sandbox header for real results from up to 7 data sources (the ones your request gives identifiers for):
